$(function() {
    ...
    $('#form_singin').submit(function (e) {
        ...
        var form = $(this);
        var actionUrl = "/api/auth/signin";


        var data = JSON.stringify({ "username": $('form input[name="username"]').val(), "password": $('form input[name="password"]').val() });
...
if ($('form input[name="pass"]').val()===$('form input[name="confirmpassword"]').val() && ret){
    ...
    var form = $(this);
    var actionUrl = "/api/auth/signup";



     var data = JSON.stringify({ "username": $('form input[name="usernameup"]').val(), "password": $('form input[name="pass"]').val(),"email":$('form input[name="email"]').val() });
    console.log(data);
    $.ajax({
        url:actionUrl,
        headers: {
