...
// создаем элемент
            ...
            form_atr_2.value="";//Заполнить куда отправлять форму
            ...
            var elem_10 = document.createElement("input");
            var elem_atr_10_1=document.createAttribute("id");
            elem_atr_10_1.value="ad_submit"+item.id;
            elem_10.setAttributeNode(elem_atr_10_1);
            var elem_atr_10_2=document.createAttribute("type");
            elem_atr_10_2.value="submit";
            elem_10.setAttributeNode(elem_atr_10_2);
            var elem_atr_10_3=document.createAttribute("value");
            elem_atr_10_3.value="Активировать";
            elem_10.setAttributeNode(elem_atr_10_3);
            form.appendChild(elem_10);

            var elem_11 = document.createElement("input");
            var elem_atr_11_1=document.createAttribute("id");
            elem_atr_11_1.value="ad_delete"+item.id;
            elem_11.setAttributeNode(elem_atr_11_1);
            var elem_atr_11_2=document.createAttribute("type");
            elem_atr_11_2.value="submit";
            elem_11.setAttributeNode(elem_atr_11_2);
            var elem_atr_11_3=document.createAttribute("value");
            elem_atr_11_3.value="Не допустить";
            elem_11.setAttributeNode(elem_atr_11_3);
